...
class _GalleryScreenState extends State<GalleryScreen> with SingleTickerProviderStateMixin {
  ...
  Future<ImageMetadata> _createMetadata(ImageWithDate imageWithDate) async {
    ...
    try {
      ...
      final currentLocation = await PhotoManager.getCurrentLocation();
      if (currentLocation != null) {
        location = await PhotoManager.getPlaceName(currentLocation);
      }
...
class PhotoManager {
  ...
  static Map<String, List<PhotoMetadata>> categorizeByLocation(List<PhotoMetadata> photos) {
  ...
  static Map<String, List<PhotoMetadata>> categorizeByDate(List<PhotoMetadata> photos) {
